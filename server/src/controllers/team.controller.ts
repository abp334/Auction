...
export async function getTeam(req: Request, res: Response) {
  ...
  if (!team) return res.status(StatusCodes.NOT_FOUND).json({ error: 'Team not found' });
...
export async function createTeam(req: Request, res: Response) {
  ...
  if (exists) return res.status(StatusCodes.CONFLICT).json({ error: 'Team name already exists' });
...
export async function deleteTeam(req: Request, res: Response) {
  ...
  if (!deleted) return res.status(StatusCodes.NOT_FOUND).json({ error: 'Team not found' });
