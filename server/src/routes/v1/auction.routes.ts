...
import { closeAuction, createAuction, listAuctions, placeBid, startAuction, getAuction, pauseAuction, resumeAuction, setCurrentPlayer, sellCurrent } from '../../controllers/auction.controller';
...
router.post('/:id/current', requireAuth, requireRoles(['admin']), setCurrentPlayer);
router.post('/:id/bid', requireAuth, requireRoles(['admin', 'captain']), placeBid);
